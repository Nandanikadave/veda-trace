...
const DUMMY_CARD_DATA = [
  { id: 1, title: "The DNA of Trust: Why Your Ayurvedic Herbs Are Now Scan-Verified.", date: "11.09.25", readTime: "3 min" },
  { id: 2, title: "Next Level Health: How Technology is Verifying Ancient Wisdom.", date: "12.09.25", readTime: "5 min" },
  { id: 3, title: "Ancient Secrets, Modern Proof: Scanning Herbs for Authenticity.", date: "13.09.25", readTime: "4 min" },
  { id: 4, title: "The Power of Purity: Traceability in Modern Ayurvedic Medicine.", date: "14.09.25", readTime: "3 min" },
];
...
const StoryCard: React.FC<StoryCardProps> = ({ data, position, onClick }) => {
  ...
  return (
    <div 
      ...
      onClick={onClick}
    >
      <div className="w-full h-52 bg-[#e8e6d9] rounded-xl relative">
        <span className="absolute left-1/2 -translate-x-1/2 -bottom-3 px-3 py-1 text-sm font-semibold bg-[#a0d89c] text-green-800 rounded-full shadow-md">
          Blog
        </span>
      </div>
